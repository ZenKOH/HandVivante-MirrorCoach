...
const APP_SCRIPTS = ['js/01-base.js', 'js/02-exercises.js', 'js/03-tutorial-content.js', 'js/04-manual-content.js', 'js/05-sample-state.js', 'js/06-core.js', 'js/07-patients-protocols.js', 'js/08-session.js', 'js/09-library-tutorial.js', 'js/10-manual-outcomes-research.js', 'js/11-init.js', 'js/12-international-ui.js'];
const BUILD_VERSION = '20260713-6';
