const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    html: `<h4>Guiding hand</h4><ol><li>Place the less-affected hand in the sensor glove according to the current IFU.</li><li>Align each finger with its sensor channel and secure the glove without constriction.</li></ol>
  ...
  },
  {
    ...
    html: `<p>The supplied training material highlights reaching and grasping, bilateral and unilateral training, fine motor activity, and conventional occupational therapy objects.</p>
